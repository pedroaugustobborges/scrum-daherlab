...
export default function RetrospectiveBoard({
  ...
  const currentMood =
    moodIcons.find((m) => m.value === retrospective?.mood_rating) ||
    moodIcons[2];
                ...
                return (
                  <Tooltip key={mood.value} title={mood.label}>
                    <IconButton
                      ...
                      sx={{
                        bgcolor:
                          retrospective?.mood_rating === mood.value
                            ? `${mood.color}20`
                            : "transparent",
                    ...
                    {editingItemId === item.id ? (
                      ...
                      <Box>
                        ...
                        >
                          ...
                          <Tooltip title="Salvar (Ctrl+Enter)">
                            ...
                            >
                              <Check
                                sx={{ fontSize: 18, color: column.color }}
                              />
                            </IconButton>
                          </Tooltip>
                        </Box>
                      ...
                      <>
                        ...
                        >
                          <Typography
                            variant="body2"
                            sx={{ flex: 1, pr: 1, whiteSpace: "pre-wrap" }}
                          >
                            {item.content}
                          </Typography>
                          {item.created_by === currentUser && (
                            ...
                            >
                              <Tooltip title="Editar">
                                ...
                                >
                                  <Edit
                                    sx={{ fontSize: 16, color: column.color }}
                                  />
                                </IconButton>
                              </Tooltip>
