      ...
      const storiesWithSubtasks = await Promise.all(
        transformedStories.map(async (story) => {
          try {
            ...
            return { ...story, subtasks: transformedSubtasks }
          } catch {
  ...
  return (
    <Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, flexWrap: 'wrap', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <FormControl size="small" sx={{ minWidth: 180 }}>
              ...
              >
                <MenuItem value="all">Todas as Histórias</MenuItem>
                  ...
                  <MenuItem key={sprint.id} value={sprint.id}>
                    ...
                    {sprint.status === 'active' && (
                      <Chip
                        label="Ativo"
                        size="small"
                        sx={{ ml: 1, height: 18, fontSize: '0.65rem', bgcolor: '#10b981', color: 'white' }}
                      />
                    )}
                  </MenuItem>
                ))}
      ...
      <CreateUserStoryModal
        ...
        sprintId={selectedSprintId !== 'all' && selectedSprintId !== 'backlog' ? selectedSprintId : undefined}
